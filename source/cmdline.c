...
const char *gengetopt_args_info_purpose = "walker is a game use yaml for making scenarios.";

const char *gengetopt_args_info_usage = "Usage: walker [OPTION]...";
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->config_arg = gengetopt_strdup ("$HOME/.config/walker");
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'C':	/* Set config directory.  */
        
        
          if (update_arg( (void *)&(args_info->config_arg), 
               &(args_info->config_orig), &(args_info->config_given),
              &(local_args_info.config_given), optarg, 0, "$HOME/.config/walker", ARG_STRING,
